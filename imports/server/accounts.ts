...
Meteor.startup(() => {
    ...
    Accounts.emailTemplates.verifyEmail.html = function (user, url) {
        ...
        const email = (
            ...
            + '<p>Seja bem vindo ao &nbsp;<strong>MeteorReactBase</strong>.</p>'
            ...
            + '<p><br/>Equipe <b>MeteorReactBase</b></p>'
        );
        const footer = (
    ...
    Accounts.emailTemplates.resetPassword.html = function (user, url) {
        ...
        const email = (
            `${`<p>Olá ${userData.username || 'usuário'},</p>`
            + '<p>Sua senha de acesso ao <strong>MeteorReactBase</strong> será alterada.</p>'
